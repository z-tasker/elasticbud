...
def get_elasticsearch_client(
    ...
    elasticsearch_client_port: Union[str,int] = os.getenv("ELASTICBUDTEST_CLIENT_PORT", 443),
    ...
    for i, arg in enumerate([elasticsearch_client_fqdn, elasticsearch_client_port, elasticsearch_username, elasticsearch_password]):
